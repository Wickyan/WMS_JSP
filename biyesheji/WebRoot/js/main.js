...
//	
//	 
//   if(document.Alogin.in_be.value == ""||document.Alogin.pass.value == "") {
//	//   alert(document.Alogin.in_be.value);
//          alert("请输入您的账户或密码！");
//
...
//      //    alert("出去了");
//    }
//    if(document.Clogin.cin_be.value == ""||document.Clogin.cpass.value == "") {
//        alert("请输入您的账户或密码！");
